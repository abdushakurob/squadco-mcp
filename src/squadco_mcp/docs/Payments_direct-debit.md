...
[Skip to main content](https://docs.squadco.com/Payments/direct-debit/#__docusaurus_skipToContent_fallback)
...
[Support](https://squadco.com/support/)[Create Account](https://dashboard.squadco.com/sign-up)[Sign In](https://dashboard.squadco.com/login)
  ...
  * [Payments](https://docs.squadco.com/Payments/direct-debit/)
  ...
  * [Webhook & Redirect URL](https://docs.squadco.com/Payments/direct-debit/)
  * [Virtual Accounts](https://docs.squadco.com/Payments/direct-debit/)
  * [Transfer API](https://docs.squadco.com/Payments/direct-debit/)
  * [Others](https://docs.squadco.com/Payments/direct-debit/)
  * [Value Added Services (VAS)](https://docs.squadco.com/Payments/direct-debit/)
...
### Direct Debit Flow[​](https://docs.squadco.com/Payments/direct-debit/#direct-debit-flow "Direct link to Direct Debit Flow")
...
#### Parameters
### Sample BankList Response[​](https://docs.squadco.com/Payments/direct-debit/#sample-banklist-response "Direct link to Sample BankList Response")
...
### Sample Request[​](https://docs.squadco.com/Payments/direct-debit/#sample-request "Direct link to Sample Request")
...
### Webhook Notification For Mandate Creation[​](https://docs.squadco.com/Payments/direct-debit/#webhook-notification-for-mandate-creation "Direct link to Webhook Notification For Mandate Creation")
...
### Webhook Notification for Approved Mandate[​](https://docs.squadco.com/Payments/direct-debit/#webhook-notification-for-approved-mandate "Direct link to Webhook Notification for Approved Mandate")
...
### Sample Request[​](https://docs.squadco.com/Payments/direct-debit/#sample-request-1 "Direct link to Sample Request")
...
### Webhook Notification[​](https://docs.squadco.com/Payments/direct-debit/#webhook-notification "Direct link to Webhook Notification")
...
### Sample Request[​](https://docs.squadco.com/Payments/direct-debit/#sample-request-2 "Direct link to Sample Request")
...
### Go Live[​](https://docs.squadco.com/Payments/direct-debit/#go-live "Direct link to Go Live")
To go live, simply:
...
[](https://github.com/HabariPay/habaripay.github.io/tree/main/docs/Payments/direct-debit.mdx)
[Previous Direct API Integration](https://docs.squadco.com/Payments/direct-api-integration)[Next Squad Woo Commerce Plugin](https://docs.squadco.com/Payments/squad-woo-squad-plugin)
  * [Direct Debit Flow](https://docs.squadco.com/Payments/direct-debit/#direct-debit-flow)
  * [Sample BankList Response](https://docs.squadco.com/Payments/direct-debit/#sample-banklist-response)
  * [Sample Request](https://docs.squadco.com/Payments/direct-debit/#sample-request)
  * [Webhook Notification For Mandate Creation](https://docs.squadco.com/Payments/direct-debit/#webhook-notification-for-mandate-creation)
  * [Webhook Notification for Approved Mandate](https://docs.squadco.com/Payments/direct-debit/#webhook-notification-for-approved-mandate)
  * [Sample Request](https://docs.squadco.com/Payments/direct-debit/#sample-request-1)
  * [Webhook Notification](https://docs.squadco.com/Payments/direct-debit/#webhook-notification)
  * [Sample Request](https://docs.squadco.com/Payments/direct-debit/#sample-request-2)
  * [Go Live](https://docs.squadco.com/Payments/direct-debit/#go-live)
