...
[Skip to main content](https://docs.squadco.com/Transfer-API/transfer-apis/#__docusaurus_skipToContent_fallback)
...
[Support](https://squadco.com/support/)[Create Account](https://dashboard.squadco.com/sign-up)[Sign In](https://dashboard.squadco.com/login)
  ...
  * [Payments](https://docs.squadco.com/Transfer-API/transfer-apis/)
  * [Webhook & Redirect URL](https://docs.squadco.com/Transfer-API/transfer-apis/)
  * [Virtual Accounts](https://docs.squadco.com/Transfer-API/transfer-apis/)
  ...
  * [Others](https://docs.squadco.com/Transfer-API/transfer-apis/)
  * [Value Added Services (VAS)](https://docs.squadco.com/Transfer-API/transfer-apis/)
...
On this page
# Transfer API
##### These are suites of API that allows you move funds from your Squad Ledger to a bank Account.[​](https://docs.squadco.com/Transfer-API/transfer-apis/#these-are-suites-of-api-that-allows-you-move-funds-from-your-squad-ledger-to-a-bank-account "Direct link to These are suites of API that allows you move funds from your Squad Ledger to a bank Account.")
...
#### Available Bank Codes[​](https://docs.squadco.com/Transfer-API/transfer-apis/#available-bank-codes "Direct link to Available Bank Codes")
...
#### Sample Request[​](https://docs.squadco.com/Transfer-API/transfer-apis/#sample-request "Direct link to Sample Request")
...
#### Sample Response[​](https://docs.squadco.com/Transfer-API/transfer-apis/#sample-response "Direct link to Sample Response")
...
### Fund Transfer[​](https://docs.squadco.com/Transfer-API/transfer-apis/#fund-transfer "Direct link to Fund Transfer")
...
#### Transaction Reference:[​](https://docs.squadco.com/Transfer-API/transfer-apis/#transaction-reference "Direct link to Transaction Reference:")
...
#### For instance:[​](https://docs.squadco.com/Transfer-API/transfer-apis/#for-instance "Direct link to For instance:")
...
#### ERROR CODE[​](https://docs.squadco.com/Transfer-API/transfer-apis/#error-code "Direct link to ERROR CODE")
...
### Sample Request[​](https://docs.squadco.com/Transfer-API/transfer-apis/#sample-request-1 "Direct link to Sample Request")
...
### Re-query Transfer[​](https://docs.squadco.com/Transfer-API/transfer-apis/#re-query-transfer "Direct link to Re-query Transfer")
...
String
Unique Transaction Reference used to initiate a transfer. Please ensure that you append your merchant ID to the transaction Reference you are creating. This is compulsory as it will throw an error if you don't append it.
#### Sample Request[​](https://docs.squadco.com/Transfer-API/transfer-apis/#sample-request-2 "Direct link to Sample Request")
...
### Get All Transfers[​](https://docs.squadco.com/Transfer-API/transfer-apis/#get-all-transfers "Direct link to Get All Transfers")
...
### Best Practises[​](https://docs.squadco.com/Transfer-API/transfer-apis/#best-practises "Direct link to Best Practises")
  1. When fund Transfer is called, do not depend only on the status code returned, review the data returned an ensure the nip_transaction_reference returned a session ID
...
[](https://github.com/HabariPay/habaripay.github.io/tree/main/docs/Transfer-API/transfer-apis.mdx)
[Previous Dynamic Virtual Account Overview](https://docs.squadco.com/Virtual-accounts/dynamic-virtual-account-v2)[Next Ledger Balance](https://docs.squadco.com/Transfer-API/ledger-balance)
  * [Account Lookup](https://docs.squadco.com/Transfer-API/transfer-apis/#account-lookup)
  * [Fund Transfer](https://docs.squadco.com/Transfer-API/transfer-apis/#fund-transfer)
  * [Sample Request](https://docs.squadco.com/Transfer-API/transfer-apis/#sample-request-1)
  * [Re-query Transfer](https://docs.squadco.com/Transfer-API/transfer-apis/#re-query-transfer)
  * [Get All Transfers](https://docs.squadco.com/Transfer-API/transfer-apis/#get-all-transfers)
  * [Best Practises](https://docs.squadco.com/Transfer-API/transfer-apis/#best-practises)
