...
[Skip to main content](https://docs.squadco.com/Virtual-accounts/api-specifications/#__docusaurus_skipToContent_fallback)
...
[Support](https://squadco.com/support/)[Create Account](https://dashboard.squadco.com/sign-up)[Sign In](https://dashboard.squadco.com/login)
  ...
  * [Payments](https://docs.squadco.com/Virtual-accounts/api-specifications/)
  * [Webhook & Redirect URL](https://docs.squadco.com/Virtual-accounts/api-specifications/)
  * [Virtual Accounts](https://docs.squadco.com/Virtual-accounts/api-specifications/)
  ...
  * [Transfer API](https://docs.squadco.com/Virtual-accounts/api-specifications/)
  * [Others](https://docs.squadco.com/Virtual-accounts/api-specifications/)
  * [Value Added Services (VAS)](https://docs.squadco.com/Virtual-accounts/api-specifications/)
...
On this page
# API Specifications
### Specification For Virtual Accounts[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#specification-for-virtual-accounts "Direct link to Specification For Virtual Accounts")
...
### Customer Model[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#customer-model "Direct link to Customer Model")
...
### Sample Request[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#sample-request "Direct link to Sample Request")
...
### Business Model[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#business-model "Direct link to Business Model")
...
### Sample Request[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#sample-request-1 "Direct link to Sample Request")
...
## Transaction Notification Service[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#transaction-notification-service "Direct link to Transaction Notification Service")
...
### Expected webhook response[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#expected-webhook-response "Direct link to Expected webhook response")
  * 200: Successful
...
## Webhook Validation --version 1[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#webhook-validation---version-1 "Direct link to Webhook Validation --version 1")
### Method 1 (Hash Comparison)[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#method-1-hash-comparison "Direct link to Method 1 \(Hash Comparison\)")
...
### Sample Implementations[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#sample-implementations "Direct link to Sample Implementations")
  * C#
  * Javascript (Node)
  * PHP
  * Java
...
### Method 2 (Decryption of Encrypted Body)[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#method-2-decryption-of-encrypted-body "Direct link to Method 2 \(Decryption of Encrypted Body\)")
...
### Sample Webhook Notification[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#sample-webhook-notification "Direct link to Sample Webhook Notification")
...
## Webhook Validation --version 2[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#webhook-validation---version-2 "Direct link to Webhook Validation --version 2")
...
## Webhook Validation --version 3[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#webhook-validation---version-3 "Direct link to Webhook Validation --version 3")
...
### Sample signature string[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#sample-signature-string "Direct link to Sample signature string")
...
#### Sample v2 and v3 notifications[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#sample-v2-and-v3-notifications "Direct link to Sample v2 and v3 notifications")
...
## Webhook Error Log[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#webhook-error-log "Direct link to Webhook Error Log")
...
### Get Webhook Error Log[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#get-webhook-error-log "Direct link to Get Webhook Error Log")
GET
...
### Delete Webhook Error Log[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#delete-webhook-error-log "Direct link to Delete Webhook Error Log")
DELETE
...
### Query Transactions Using Customer Identifier[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#query-transactions-using-customer-identifier "Direct link to Query Transactions Using Customer Identifier")
...
### Query All Merchant's Transactions[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#query-all-merchants-transactions "Direct link to Query All Merchant's Transactions")
...
### Query All Merchant Transactions with Multiple Filters[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#query-all-merchant-transactions-with-multiple-filters "Direct link to Query All Merchant Transactions with Multiple Filters")
...
### Get Customer Details by Virtual Account Number[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#get-customer-details-by-virtual-account-number "Direct link to Get Customer Details by Virtual Account Number")
...
### Get Customer Details Using Customer Identifier[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#get-customer-details-using-customer-identifier "Direct link to Get Customer Details Using Customer Identifier")
This endpoint retrieves customer details using the Virtual Account Number.
GET
...
### Query All Merchant's Virtual Accounts[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#query-all-merchants-virtual-accounts "Direct link to Query All Merchant's Virtual Accounts")
...
#### Simulate Payment[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#simulate-payment "Direct link to Simulate Payment")
...
### Going Live[​](https://docs.squadco.com/Virtual-accounts/api-specifications/#going-live "Direct link to Going Live")
...
[](https://github.com/HabariPay/habaripay.github.io/tree/main/docs/Virtual-accounts/api-specifications.mdx)
[Previous Virtual Accounts](https://docs.squadco.com/Virtual-accounts/virtual-account)[Next Encryption & Decryption](https://docs.squadco.com/Virtual-accounts/encryption-decryption)
  * [Specification For Virtual Accounts](https://docs.squadco.com/Virtual-accounts/api-specifications/#specification-for-virtual-accounts)
  * [Customer Model](https://docs.squadco.com/Virtual-accounts/api-specifications/#customer-model)
  * [Sample Request](https://docs.squadco.com/Virtual-accounts/api-specifications/#sample-request)
  * [Business Model](https://docs.squadco.com/Virtual-accounts/api-specifications/#business-model)
  * [Sample Request](https://docs.squadco.com/Virtual-accounts/api-specifications/#sample-request-1)
  * [Transaction Notification Service](https://docs.squadco.com/Virtual-accounts/api-specifications/#transaction-notification-service)
    * [Expected webhook response](https://docs.squadco.com/Virtual-accounts/api-specifications/#expected-webhook-response)
  * [Webhook Validation --version 1](https://docs.squadco.com/Virtual-accounts/api-specifications/#webhook-validation---version-1)
    * [Method 1 (Hash Comparison)](https://docs.squadco.com/Virtual-accounts/api-specifications/#method-1-hash-comparison)
    * [Sample Implementations](https://docs.squadco.com/Virtual-accounts/api-specifications/#sample-implementations)
    * [Method 2 (Decryption of Encrypted Body)](https://docs.squadco.com/Virtual-accounts/api-specifications/#method-2-decryption-of-encrypted-body)
    * [Sample Webhook Notification](https://docs.squadco.com/Virtual-accounts/api-specifications/#sample-webhook-notification)
  * [Webhook Validation --version 2](https://docs.squadco.com/Virtual-accounts/api-specifications/#webhook-validation---version-2)
  * [Webhook Validation --version 3](https://docs.squadco.com/Virtual-accounts/api-specifications/#webhook-validation---version-3)
    * [Sample signature string](https://docs.squadco.com/Virtual-accounts/api-specifications/#sample-signature-string)
  * [Webhook Error Log](https://docs.squadco.com/Virtual-accounts/api-specifications/#webhook-error-log)
    * [Get Webhook Error Log](https://docs.squadco.com/Virtual-accounts/api-specifications/#get-webhook-error-log)
    * [Delete Webhook Error Log](https://docs.squadco.com/Virtual-accounts/api-specifications/#delete-webhook-error-log)
    * [Query Transactions Using Customer Identifier](https://docs.squadco.com/Virtual-accounts/api-specifications/#query-transactions-using-customer-identifier)
    * [Query All Merchant's Transactions](https://docs.squadco.com/Virtual-accounts/api-specifications/#query-all-merchants-transactions)
    * [Query All Merchant Transactions with Multiple Filters](https://docs.squadco.com/Virtual-accounts/api-specifications/#query-all-merchant-transactions-with-multiple-filters)
    * [Get Customer Details by Virtual Account Number](https://docs.squadco.com/Virtual-accounts/api-specifications/#get-customer-details-by-virtual-account-number)
    * [Get Customer Details Using Customer Identifier](https://docs.squadco.com/Virtual-accounts/api-specifications/#get-customer-details-using-customer-identifier)
    * [Query All Merchant's Virtual Accounts](https://docs.squadco.com/Virtual-accounts/api-specifications/#query-all-merchants-virtual-accounts)
    * [Going Live](https://docs.squadco.com/Virtual-accounts/api-specifications/#going-live)
